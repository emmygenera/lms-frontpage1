    ...
    return (
        <>
            <Row className="mt-4 ms-1" style={{ paddingTop: "50px" }}>
                <Col sm={3}>
                    <Link className="d-inline-flex tlinkbtn" to="newLesson" style={{ backgroundColor: "#F1F1F1" }}>
                        <p className=" px-3 py-md-2 px-md-4">+New Ticket</p>
                    </Link>
                </Col>
                <Col sm={9} className="shadow-sm col2 mt-1" style={{ borderRadius: "1em" }}>
                    <Row className="py-md-2">
                        <Col sm={7} md={8} className="hidediv" style={{ position: "relative" }}>
                            <i class="bi bi-person tsearchicon"></i>
                            <input id="tsearchinput" type="search" placeholder="Search here" />
