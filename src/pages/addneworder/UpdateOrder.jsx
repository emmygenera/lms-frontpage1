        ...
        <>
            <Row>
                <Col md={5} className="offset-md-1">
                    ...
                    <div>
                        <p style={{ display: "inline", marginLeft: "-8px" }}>Address 2</p> <input type="text" className="mb-4 myinput" style={{ marginLeft: "-px" }} />
                    </div>
                    <button id="mybtnupdate" style={{ marginLeft: "60px" }}>
                        Update
                    </button>
                </Col>
                <Col md={5}>
                    ...
                    <div>
                        Courses
                        <select className="mb-4 py-1 myinput" style={{ paddingRight: "95px", marginLeft: "13px" }}>
                    ...
                    <div>
                        <p style={{ display: "inline", marginLeft: "-55px" }}>Package Available</p>
